...
{
    public class RandomUSqrt : Random
    {
        private static readonly Random rnd = new();

        /// *******************************************************************
        /// Sample returns a random number with a distribution concentrated on 1 
        /// and gradually decending towards zero
        ...
        */
        ...
        {           
            return Math.Sqrt(rnd.NextDouble());
        }
